  ...
  return (
    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://dysrup.com.br" class="flex items-center">
                <img src="https://dysrup.com.br/wp-content/uploads/2022/11/logo-dysryp-colorida.png" class="mr-3 h-6 sm:h-9" alt="Dysrup Logo" /> 
            </a>
